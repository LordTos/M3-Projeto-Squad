        ...
        <div className={styles.papai}>
            ...
            <div className={styles.Pai}>
                <div className={styles.cards}>
                    <div class="w3-card-4">
                        <img className={styles.imgAcademia} src="https://www.lifefitness.com.br/resource/image/1868258/landscape_ratio16x9/720/405/c2d12126812afcd94d4bed966f3f9e7b/tt/oktopus-1.png" alt="Alps" />
                ...
                <div className={styles.cards}>
                    ...
                    <div className="w3-card-4">
                        <img  className={styles.imgAcademia} src="https://www.aubicon.com.br/wp-content/uploads/2022/06/4-dicas-de-como-organizar-o-layout-da-sua-academia_blog_1200x800px_100_img2.png" alt="Alps" />
                        <div className="w3-container w3-center">
                            <p></p>
                        </div>
                    </div>
